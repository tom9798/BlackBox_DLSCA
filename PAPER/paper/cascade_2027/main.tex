...
The best previous result reported in this raw-trace setting, Perin et al.~\cite{perin2022exploring}, reaches single-trace success on some key bytes and requires up to three traces for the most resilient ones; we improve on both numbers in \cref{sec:results}.
